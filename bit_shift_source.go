...
func NewBitShiftSource(shards uint32, seedFn func() int64) *BitShiftSource {
...
func (s *BitShiftSource) Int63() int64 {
...
func (s *BitShiftSource) Seed(seed int64) {
